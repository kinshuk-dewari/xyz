...
//         <h1 className="text-4xl text-white p-2 font-bold">Infrastructure </h1>
...
const Infrastructure = () => {
  ...
  return (
    <div className="p-4  mx-full rounded-md bg-[#0f4b8a] shadow-lg">
      <h1 className="text-3xl font-bold text-start text-white mb-6 ">Infrastructure</h1>
      ...
      <div className="flex justify-start gap-4 mb-6">
        <button
          ...
          className="bg-black text-white  px-4 py-2 rounded-md shadow hover:bg-[#00bbf1] "
        >
          Predict
        </button>
